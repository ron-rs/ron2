...
mod completion_integration {
    use super::*;
    use ron_lsp::{Document, SchemaResolver};
...
(
    title: "Test",
        ...
        let completions = ron_lsp::provide_completions(&doc, Position::new(4, 4), &resolver);
...
"#;
        ...
        let completions = ron_lsp::provide_completions(&doc, Position::new(2, 0), &resolver);
...
"#;
    ...
    some_field: 123,
        ...
        let completions = ron_lsp::provide_completions(&doc, Position::new(1, 4), &resolver);
        assert!(
...
(
    title:
        ...
        assert_eq!(
            context,
            ron_lsp::CompletionContext::Value,
...
(
    title: "Test",
        ...
        assert_eq!(
            context,
            ron_lsp::CompletionContext::FieldName,
...
"#;
        ...
        assert_eq!(
            context,
            ron_lsp::CompletionContext::Root,
...
(
        ...
        let completions = ron_lsp::provide_completions(&doc, Position::new(3, 4), &resolver);
